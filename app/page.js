...
export default function Page() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex w-full flex-1 flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mt-6">
          <Link href="/quizzes">
            <span className="inline-block rounded-md border border-transparent bg-blue-600 px-6 py-3 text-base font-medium text-white hover:bg-blue-700 md:px-8 md:py-3.5 md:text-lg">
